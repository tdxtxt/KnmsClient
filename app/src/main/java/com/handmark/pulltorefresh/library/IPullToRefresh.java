...
public interface IPullToRefresh<T extends View> {
	 ...
	 * in the Y-axis is greater than the difference in the XCircleProgress-axis. This means
	 ...
	 * than the difference in the XCircleProgress-axis. This means that the View will not
