...
public final class OverscrollHelper {
	 ...
	 * @param deltaX - Change in XCircleProgress in pixels, passed through from from
	 *            overScrollBy call
	 * @param scrollX - Current XCircleProgress scroll value in pixels before applying deltaY,
