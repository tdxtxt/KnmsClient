...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHeaderLayout = createLoadingLayout(context, a.getBoolean(R.styleable.PullToRefresh_ptrIsShowRefreshView, true) ? Mode.PULL_FROM_START : Mode.DISABLED, a);
        mFooterLayout = createLoadingLayout(context, a.getBoolean(R.styleable.PullToRefresh_ptrIsShowLoadMoreView, true) ? Mode.PULL_FROM_END : Mode.DISABLED, a);
...
//这里不需要这个判断，原因是如果在黑屏状态下，无法测量出头、尾布局的高度，导致这里oldScrollValue = newScrollValue
