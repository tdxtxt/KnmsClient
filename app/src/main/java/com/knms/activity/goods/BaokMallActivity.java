 ...
 * 爆款推荐商城活动列表
 */
public class BaokMallActivity extends HeadNotifyBaseFragmentActivity {
...
//        pullToRefreshStickyNavLayout.getRefreshableView().setTopOffset(LocalDisplay.dp2px(46));
    ...
    protected void initData() {
        ...
        pullToRefreshStickyNavLayout.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<HeaderViewPager>() {
            ...
            public void onRefresh(PullToRefreshBase<HeaderViewPager> refreshView) {
                if(!isFrist) ((BaokMallFragment)((MallFragmentAdapter)viewPager.getAdapter()).getItem(viewPager.getCurrentItem())).refresh(true);
                reqApi();
            }
        });
    ...
    private void updateView(List<Tab> data) {
        ...
        final MallFragmentAdapter fragmentAdapter = new MallFragmentAdapter(getSupportFragmentManager(),data,true);
