...
package com.knms.adapter.baserecycler;
...
import com.knms.adapter.baserecycler.animation.AlphaInAnimation;
import com.knms.adapter.baserecycler.animation.BaseAnimation;
import com.knms.adapter.baserecycler.animation.ScaleInAnimation;
import com.knms.adapter.baserecycler.animation.SlideInBottomAnimation;
import com.knms.adapter.baserecycler.animation.SlideInLeftAnimation;
import com.knms.adapter.baserecycler.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * When index = -1 or index >= child totalCount in mHeaderLayout,
     ...
     * When index = -1 or index >= child totalCount in mFooterLayout,
     ...
     * When the child totalCount of mHeaderLayout is 0, mHeaderLayout will be set to null.
     *
     * @param header
     */
     ...
     * When the child totalCount of mFooterLayout is 0, mFooterLayout will be set to null.
     *
     * @param footer
     */
...
//      mFooterLayout = null;注释这行代码(这里置空之后若再次添加，则无法显示出来)
        }
        this.notifyDataSetChanged();
    }
...
//        mFooterLayout = null; 注释这行代码(这里置空之后若再次添加，则无法显示出来)
    ...
    protected void startAnim(Animator anim, int index) {
        if(index > 7){
            ...
            anim.setDuration(500).setStartDelay(index * 200);
            anim.start();
