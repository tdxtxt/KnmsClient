...
public class DeviceIDFactory {
    ...
    public String getIMEI() {
        TelephonyManager TelephonyMgr = (TelephonyManager) KnmsApp.getInstance().getSystemService(TELEPHONY_SERVICE);
    ...
    public String getAndroidID() {
        String m_szAndroidID = Settings.Secure.getString(KnmsApp.getInstance().getContentResolver(),
    ...
    public String getWLANMACAddress() {
        WifiManager wm = (WifiManager) KnmsApp.getInstance().getSystemService(Context.WIFI_SERVICE);
