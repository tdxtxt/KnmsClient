...
public class Star extends View {
    ...
    private void init(Context mContext, AttributeSet attrs){
        ...
        starHeight = (int) typedArray.getDimension(R.styleable.star_starHeight, LocalDisplay.dp2px(10));
        starWidth = (int) typedArray.getDimension(R.styleable.star_starWidth, LocalDisplay.dp2px(10));
