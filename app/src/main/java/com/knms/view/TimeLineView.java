...
public class TimeLineView extends View {
    ...
    private void drawCircle(Canvas canvas, int drawStep, String text, int dx) {
        ...
        canvas.drawCircle(dx,getHeight() - this.mRadius - LocalDisplay.dp2px(4),drawStep==this.mStep?this.mRadius+LocalDisplay.dp2px(2):this.mRadius, this.mPaint);
        this.mPaint.setStyle(Paint.Style.FILL);
        this.mPaint.setColor(this.mStep == drawStep ? getResources().getColor(R.color.color_white) : this.mStep > drawStep ? getResources().getColor(R.color.color_white) : getResources().getColor(R.color.common_gray));
        canvas.drawCircle(dx, getHeight() - this.mRadius - LocalDisplay.dp2px(4), drawStep==this.mStep?this.mRadius-LocalDisplay.dp2px(4):this.mRadius-LocalDisplay.dp2px(5), this.mPaint);
        ...
        canvas.drawText(text, dx - getWordCount(text) * this.mTextSize, getHeight() - this.mRadius * 2 - LocalDisplay.dp2px(20), this.mPaint);
    }
    ...
    private void drawLine(Canvas paramCanvas, int drawStep,boolean isStart, int startX, int endX) {
        ...
        paramCanvas.drawLine(drawStep==this.mStep?this.mRadius+ startX+LocalDisplay.dp2px(2):this.mRadius+ startX-1, getHeight() - this.mRadius -  LocalDisplay.dp2px(4), endX - this.mRadius+1, getHeight() - this.mRadius - LocalDisplay.dp2px(4), this.mPaint);
    }
