...
public class StickerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageLoadHelper.getInstance().displayImage(context,StickerManager.getInstance().getStickerBitmapUri(sticker.getCategory(), sticker.getName()),viewHolder.imageView,LocalDisplay.dip2px(64), LocalDisplay.dip2px(64));
