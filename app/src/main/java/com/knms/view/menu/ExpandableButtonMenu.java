...
public class ExpandableButtonMenu extends RelativeLayout implements View.OnClickListener {
    ...
    public void setMenuButtonImage(MenuButton button, Drawable drawable) {
        switch (button) {
            case MID:
                mMidBtn.setBackground(drawable);
                break;
            case LEFT:
    ...
    private void inflate() {
        ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.ebm_menu, this, true);

        mOverlay = findViewById(R.id.ebm__menu_overlay);
        mOverlay.setAlpha(0.1f);
        ...
        mMidBtn = (Button) findViewById(R.id.ebm__menu_middle_image);
        mRightBtn = (Button) findViewById(R.id.ebm__menu_right_image);
        mLeftBtn = (Button) findViewById(R.id.ebm__menu_left_image);

        sWidth = ScreenUtil.getScreenWidth();
        sHeight = ScreenUtil.getScreenHeight();
...
//                mLeftBtn.setText(a.getResourceId(R.styleable.ExpandableMenuOverlay_leftButtonText, R.string.empty));
//                mRightBtn.setText(a.getResourceId(R.styleable.ExpandableMenuOverlay_rightButtonText, R.string.empty));
//                mMidBtn.setText(a.getResourceId(R.styleable.ExpandableMenuOverlay_midButtonText, R.string.empty));
...
//        rParams.height = (int) (sWidth * otherButtonSize);
        rParams.setMargins(0, 0, 0, (int) (sHeight * bottomPadding + EXTRA_MARGIN) * 2);
    ...
    /**
     * Translation in XCircleProgress axis for left and right buttons
     */
