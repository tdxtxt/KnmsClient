...
import com.knms.view.wheel.adapter.WheelViewAdapter;
import com.knms.view.wheel.listener.OnWheelChangedListener;
import com.knms.view.wheel.listener.OnWheelClickedListener;
import com.knms.view.wheel.listener.OnWheelScrollListener;
...
//			0xcfE9E9E9, 0x3fE9E9E9 }
	...
	/** Default totalCount of visible items */
	...
	private int lineColor = Color.parseColor("#49BDE8");
	// Wheel drawables
	...
	/**
	 * Gets totalCount of visible items
	 *
	 * @return the totalCount of visible items
	 */
	...
	/**
	 * Sets the desired totalCount of visible items.
	 * Actual amount of visible items depends on wheel layout parameters.
	 * To apply changes and rebuild view call measure().
	 *
	 * @param count the desired totalCount for visible items
	 */
	...
	public void setLineColor(int resColor) {
		this.lineColor = resColor;
	}
}
